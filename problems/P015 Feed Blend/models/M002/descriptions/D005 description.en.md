...
2. **Mandatory Composition:** Certain feedstock categories, designated as $\text{G}$ (Grains), must always contribute a
   minimum proportional fraction (e.g., $20\%$) of the total mass ($\text{W}$) utilized in the blend to maintain quality
   standards.

3. **Material Flow and Storage:** The operation must respect initial inventory
...
4. **Financial Structure:** Costs are complex: Ingredients $\text{i}$ carry a varying purchase
