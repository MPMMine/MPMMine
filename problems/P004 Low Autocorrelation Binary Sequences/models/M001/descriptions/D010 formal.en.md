...
as $\sum\limits_{j=1}^{N-l} X_j * X_{j+l}$. The objective is to minimize the total squared value of these correlations.
This is achieved by minimizing the expression $T = \sum\limits_{l=1}^{N-1} R_l^2$.
