...
positions: $\sum_{i=1}^{n-k} S_i * S_{i+k}$. The objective is to minimize the sum of the squares of these
autocorrelations. In other words, the aim is to minimize $E=\sum_{k=1}^{n-1} C_k^2$.
