...
pairs: $R_k = \sum_{j=1}^{\gamma-k} X_j * X_{j+k}$. The ultimate objective is to minimize the cumulative sum of
the squared self-correlations across all possible separations, represented as $F = \sum_{k=1}^{\gamma-1} R_k^2$.
