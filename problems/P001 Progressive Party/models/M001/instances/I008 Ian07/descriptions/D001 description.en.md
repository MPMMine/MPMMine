...
For this specific instance of the problem, we have the following parameters:

*   **Total number of boats:** 11
*   **Total number of time periods:** 5

The individual characteristics for each of the 11 boats are as follows:

| Boat # | Capacity | Crew Size |
|:------:|:--------:|:---------:|
| 1      | 6        | 2         |
| 2      | 8        | 2         |
| 3      | 12       | 2         |
