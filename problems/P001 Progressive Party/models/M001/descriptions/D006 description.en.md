...
A critical rule is that a guest boat cannot revisit any host boat, and no two distinct boat crews may meet more than
once. The objective for the event organizer is to determine the smallest number of boats required to serve as hosts.
