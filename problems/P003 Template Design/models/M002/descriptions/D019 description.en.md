...
produced, for one template, two templates, and so on. Additionally, to eliminate equivalent symmetric solutions, 
variations with identical demand requirements are ordered lexicographically according to their slot allocations 
across all templates. Furthermore, to break pseudo-symmetries, the total quantity printed for any variation must be 
less than or equal to the total quantity printed for any variation that has a larger initial demand requirement.
