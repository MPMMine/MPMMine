...
To eliminate redundant configurations and improve optimization efficiency, the selection of supplier bars must follow a strict order, ensuring that a bar is only considered for use if the preceding bar in the sequence has also been utilized.
